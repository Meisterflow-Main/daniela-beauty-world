    ...
    <section id="warteliste" className="py-24 gradient-rose">
      <div className="max-w-3xl mx-auto px-5 md:px-8 text-center">
        <ScrollReveal>
          ...
          <span className="text-white/80 text-sm font-heading font-medium tracking-[0.25em] uppercase block mt-4 mb-8 -ml-1">Seien Sie die Erste mit einer Weltneuheit</span>
          {!sent ? (
